      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-16 space-y-12">
        ...
        <section>
          ...
          <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
            By accessing and using OSPL, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service. OSPL reserves the right to make changes to these Terms & Conditions at any time, at its sole discretion. We will notify users of any material changes by updating the "Last Updated" date at the top of this page. Continued use of OSPL after such notifications constitutes your acceptance of the modified Terms & Conditions.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-4">
            OSPL is a comprehensive prompt library and discovery platform featuring:
          </p>
          ...
          <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
            The specific features available may change at any time at OSPL's sole discretion. We reserve the right to modify, discontinue, or add services at any time.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
                You can create an OSPL account through GitHub authentication. By creating an account, you agree to provide accurate, complete, and current information about yourself and maintain the security of your account credentials.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
                Maintain strong, unique passwords and do not share your GitHub credentials. OSPL is not responsible for unauthorized access to your account resulting from your negligence in protecting your login credentials. If you believe your account has been compromised, contact us immediately at support@ospl.dev.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
                We reserve the right to suspend or terminate your account and access to OSPL if we determine, in our sole discretion, that you have violated these Terms & Conditions or engaged in conduct harmful to the service, other users, or our platform.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
                You retain all ownership rights to any prompts, descriptions, reviews, and content you submit to OSPL ("Your Content"). By submitting Your Content to OSPL, you grant us a non-exclusive, royalty-free, worldwide, perpetual license to use, reproduce, modify, distribute, and display Your Content within OSPL and related services. You agree that other users may view, bookmark, rate, and reference your submitted content.
              </p>
            </div>
        ...
        <section>
          ...
          <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-4">
            You agree not to use OSPL for any unlawful purpose or in any way that violates these Terms & Conditions. Specifically, you agree not to:
          </p>
          <ul className="list-disc list-inside text-neutral-700 dark:text-neutral-300 space-y-2 ml-2">
            ...
            <li>Attempt to gain unauthorized access to OSPL systems or other users' accounts</li>
            ...
            <li>Reverse engineer, decompile, or attempt to discover the source code of OSPL</li>
            <li>Interfere with the proper functioning of OSPL infrastructure</li>
            <li>Use OSPL to collect or store personal information about other users</li>
        ...
        <section>
          ...
          <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-4">
            OSPL and its original content, features, and functionality are owned by OSPL, its licensors, and other providers of such material and are protected by copyright, trademark, and other intellectual property laws.
          </p>
          <ul className="list-disc list-inside text-neutral-700 dark:text-neutral-300 space-y-2 ml-2 mb-4">
            ...
            <li><strong>License:</strong> We grant you a limited, non-exclusive license to use OSPL for personal, non-commercial purposes. This license does not include the right to download, reproduce, or redistribute our platform or its content (except as explicitly permitted by the platform).</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-4">
            OSPL uses Google Gemini API to automatically analyze and generate metadata for prompts. Please note the following important disclaimers:
          </p>
          <div className="space-y-3">
            ...
            <div className="bg-yellow-50 dark:bg-yellow-950 p-4 rounded-lg border border-yellow-200 dark:border-yellow-800">
              ...
              <p className="text-sm text-yellow-800 dark:text-yellow-200">
                OSPL is not liable for inaccuracies in AI-generated metadata or for any consequences of relying on such metadata.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
                OSPL is provided on an "AS IS" and "AS AVAILABLE" basis. We make no warranties, express or implied, regarding the service, including but not limited to warranties of merchantability, fitness for a particular purpose, non-infringement, or compatibility with your systems. We do not warrant that OSPL will be error-free, uninterrupted, or free from viruses or other harmful components.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
                To the maximum extent permitted by law, OSPL and its owners, employees, and agents shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including lost profits, revenue, data, or goodwill, arising out of or in connection with your use of OSPL, even if we have been advised of the possibility of such damages.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
                While we strive to maintain a community of quality prompts, OSPL does not verify the accuracy, legality, safety, or reliability of user-submitted content. You use all prompts and user content at your own risk.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-neutral-700 dark:text-neutral-300 space-y-2 ml-2">
            <li><strong>Modifications:</strong> We reserve the right to modify, add, or discontinue features of OSPL at any time without notice or liability.</li>
            <li><strong>Maintenance:</strong> We may temporarily disable or restrict access to OSPL for maintenance, upgrades, or repairs.</li>
            <li><strong>Service Interruptions:</strong> OSPL may be unavailable due to technical issues, infrastructure problems, or third-party service outages. We will make reasonable efforts to maintain service availability but cannot guarantee uninterrupted access.</li>
            <li><strong>No Guarantees:</strong> We do not guarantee any specific uptime percentage or service level agreements for OSPL.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-4">
            We may suspend or terminate your account and access to OSPL immediately, without notice or liability, if:
          </p>
          <ul className="list-disc list-inside text-neutral-700 dark:text-neutral-300 space-y-2 ml-2 mb-4">
          ...
          <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
            Upon termination, your right to access OSPL immediately ceases. Your previously submitted content may remain accessible to other users, and aggregate data may be retained for analytical purposes.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
            You agree to indemnify and hold harmless OSPL, its owners, employees, and agents from any claims, damages, losses, liabilities, and expenses (including attorney fees) arising out of or related to: (1) your violation of these Terms & Conditions; (2) your use of OSPL; (3) your user-submitted content; or (4) your violation of applicable laws or third-party rights.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-4">
            These Terms & Conditions are governed by and construed in accordance with the laws of the State of California, without regard to its conflict of law provisions. Any disputes arising out of or relating to these Terms & Conditions or OSPL shall be exclusively subject to the jurisdiction of the state and federal courts located in San Francisco, California, and you agree to submit to the personal and exclusive jurisdiction of such courts.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
            These Terms & Conditions, together with our Privacy Policy and any other policies published on OSPL, constitute the entire and exclusive agreement between you and OSPL regarding the use of OSPL. They supersede all prior agreements, understandings, and negotiations. There are no agreements or understandings between you and OSPL except as set forth in these documents.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-4">
            If you have any questions about these Terms & Conditions or OSPL, please contact us:
          </p>
          <div className="bg-neutral-50 dark:bg-neutral-900 p-6 rounded-lg border border-neutral-200 dark:border-neutral-800 space-y-2 text-neutral-700 dark:text-neutral-300">
            <p><strong>Email:</strong> support@ospl.dev</p>
