...
export default function AdminModerationView() {
  ...
  const [activeSection, setActiveSection] = useState<"moderation" | "feedback">(
    "moderation",
  );
  ...
  }, [activeSection, tabValue, filters]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
      <div className="max-w-[1440px] mx-auto p-4 sm:p-8 w-full">
        {error && (
          <div
            className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/50 text-red-800 dark:text-red-400 px-4 py-3 rounded-xl mb-6 shadow-sm flex items-center gap-3"
            role="alert"
          >
            <svg
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-[260px] shrink-0 md:border-r border-gray-200 dark:border-gray-800 md:pr-8 pb-6 md:pb-0">
            <h2 className="font-display text-2xl font-black text-gray-900 dark:text-white tracking-tight mb-6">
              {/* Administration Tile Header */}
              <div className="flex items-center justify-between p-3 rounded-xl bg-purple-50 dark:bg-purple-900/20 border border-purple-100 dark:border-purple-500/20 text-purple-700 dark:text-purple-300">
                <span className="font-semibold text-sm">Administration</span>
                <span className="bg-purple-600 text-white text-[10px] font-bold uppercase tracking-wider py-1 px-2.5 rounded-lg shadow-sm">
                  Admin
                </span>
              </div>
            </h2>
            <div className="flex flex-col gap-3">
              {/* Navigation Menu Tiles under Administration */}
              <div className="flex flex-col gap-1.5">
                <button
                  onClick={() => setActiveSection("moderation")}
                  className={`flex items-center gap-3 px-3.5 py-2.5 rounded-xl font-medium text-sm transition-all cursor-pointer w-full text-left ${
                ...
                >
                  <MessageSquareHeart className="w-4 h-4 shrink-0 text-purple-400" />
          ...
          <div className="flex-1 min-w-0">
            {activeSection === "feedback" ? (
              <div className="space-y-6">
                <div className="mb-6">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                    Review, filter, and manage user feedback submissions.
                  </p>
                </div>
                <AdminFeedbackView />
              </div>
              ...
              <div>
                ...
                <div
                  className="flex overflow-x-auto border-b border-gray-200 dark:border-gray-800 mb-8 scrollbar-hide"
                  role="tablist"
                >
                  {[
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                  ...
                  <div className="sm:min-w-[200px] relative">
                    ...
                    >
                      ...
                      {tabValue === 1 && (
                        <option value="Recently Approved">
                          Recently Approved
                        </option>
                      )}
                    </select>
